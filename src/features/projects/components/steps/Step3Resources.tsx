...
console.log('src/features/projects/components/steps/Step1GeneralInfo.tsx/Step3Resources');
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 shadow-sm space-y-6">
          ...
          {skillFields.map((field, index) => (
            <div key={field.id} className="grid md:grid-cols-4 gap-4 items-end">
              ...
              <div>
                ...
                <Input
                  type="number"
                  {...register(`data.resources.skillMatrix.${index}.available`, {
                    valueAsNumber: true,
                  })}
                />
              </div>
        ...
        <div className="space-y-4 border-t pt-4">
          ...
          <EditableEmployeeGrid
            ...
            onChange={(rows) => setValue('data.resources.extendedEmployees', rows)}
          />
        </div>
