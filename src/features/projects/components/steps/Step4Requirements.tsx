...
console.log('src/features/projects/components/steps/Step1GeneralInfo.tsx/Step4Requirements');
  ...
  const complianceNeeds = useWatch({ control, name: 'data.requirements.complianceNeeds' });
  const integrationTypes = useWatch({ control, name: 'data.requirements.integrationTypes' });

  const { fields, append, remove } = useFieldArray({
    control,
    name: 'data.requirements.integrationTypes',
  });
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 shadow-sm space-y-6">
        ...
        <div className="space-y-2">
          <label className="inline-flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-200">
            <input type="checkbox" {...register('data.requirements.complianceNeeds')} />
          ...
          <div className="grid md:grid-cols-2 gap-6 pt-2">
            <div>
              ...
              <Input
                ...
                {...register('data.requirements.complianceFramework')}
              />
            ...
            <div>
              ...
              <select
                {...register('data.requirements.securityLevel')}
                className="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
              >
            ...
            <div className="md:col-span-2">
              ...
              <Input
                ...
                {...register('data.requirements.storagePolicy')}
              />
            ...
            <div key={field.id} className="flex items-end gap-4">
              <div className="flex-1">
                ...
                <Input
                  ...
                  {...register(`data.requirements.integrationTypes.${idx}`)}
                />
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <Input
                  ...
                  {...register('data.requirements.cloudProvider')}
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  {...register('data.requirements.cloudRegion')}
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <Input
                  type="number"
                  {...register('data.requirements.cloudCost', { valueAsNumber: true })}
                />
              </div>
            </div>
          </div>
