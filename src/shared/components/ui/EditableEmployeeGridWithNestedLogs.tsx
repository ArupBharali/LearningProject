            ...
            <React.Fragment key={row.id}>
              <tr className="border-t border-gray-300 dark:border-gray-700">
                <td className="px-2 py-1">
                  <input
                    {...register(
                      `data.resources.extendedEmployees.${index}.name`
                    )}
                ...
                <td className="px-2 py-1">
                  <input
                    {...register(
                      `data.resources.extendedEmployees.${index}.phone`
                    )}
                    className="input w-full"
                  />
                </td>
                <td className="px-2 py-1">
                  <input
                    type="date"
                    {...register(
                      `data.resources.extendedEmployees.${index}.joiningDate`
                    )}
                    className="input w-full"
                  />
                </td>
                <td className="px-2 py-1">
                  <input
                    {...register(
                      `data.resources.extendedEmployees.${index}.comment`
                    )}
                    className="input w-full"
                  />
                </td>
